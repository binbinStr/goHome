...
Page({
    ...
    onLoad: function(t) {
        ...
        app.util.request({
            ...
            showLoading: !1,
            success: function(t) {
                if (console.log(t), t) if (9 != t.data) {
                    var e = t.data;
                    o.setData({
                        user_info: e
                    });
        ...
        app.util.request({
            ...
            success: function(t) {
              console.log(t)
              if (2 != t.data){
                if (!t.data.nosettlemoney){
                  t.data.nosettlemoney = 0;
                    console.log(t);
                }
                o.setData({
                  d_info: t.data
    ...
    shareCanvas: function() {
      ...
      console.log(t);
        ...
        this.creatPoster("wnjz_sun/pages/index/index", 430, e, 8, "shareImg");
    },
    creatPoster: function(t, e, o, n, s) {
        ...
        app.util.request({
            ...
            success: function(i) {
                console.log("获取小程序二维码"), console.log(i), u = i.data.wxcode_pic, console.log("99999999999999"), 
                console.log(u), console.log("99999999999999"), r = i.data.blogo, c = i.data.postertoptitle ? i.data.postertoptitle : o.title;
    ...
    toFxCash: function(t) {
        wx.navigateTo({
            url: "/wnjz_sun/plugin/distribution/fxCash/fxCash"
        });
    },
    toFxWd: function(t) {
        wx.navigateTo({
    ...
    toFxOrder: function(t) {
        wx.navigateTo({
            url: "/wnjz_sun/plugin/distribution/fxOrder/fxOrder"
        });
    },
    ...
    toFxTeam: function(t) {
        wx.navigateTo({
            url: "/wnjz_sun/plugin/distribution/fxTeam/fxTeam"
        });
    },
    toFxGoods: function(t) {
        wx.navigateTo({
            url: "/wnjz_sun/plugin/distribution/fxGoods/fxGoods"
        });
    }
});